  ...
  <div class="row">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{url()->current()}}">Create Blog</a></li>
      </ol>
    </section><br>
        <div class="col-md-12">
         <div class="box">
            ...
            <form role="form">
              <div class="box-body">
                ...
                <label for="exampleInputEmail1">Student's Name</label>
                  <input type="text" class="form-control ui-datepicker" id="exampleInputEmail1" name="name" placeholder="Enter Student Name" value="{{old('name')}}" >
